<template>
  <div class="relative px-1 pt-5 pb-1.5 md:px-2 md:pt-4 md:pb-2">
    ...
    <div
      ref="buttonRowRef"
      class="relative z-[1] flex flex-nowrap justify-start overflow-x-auto px-1 py-1.5 md:justify-between md:gap-[clamp(0.4rem,_0.9vw,_0.7rem)] md:px-2 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
      role="group"
    ...
    >
      <TrackerOptionButton
        ...
        :size-classes="buttonSizeClassesComputed"
...
const buttonSizeClassesComputed = computed(() => props.buttonSizeClasses)
