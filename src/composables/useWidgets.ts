...
import { useWidgetDock } from '../widgets/dock'
import { useWidgetFocus } from '../widgets/focus'
import { assignWidgetIds, useWidgetFactory } from '../widgets/factory'
import { useWidgetPersistence } from '../widgets/persistence'
import { createDefaultWidgets } from '../widgets/options'
import type { WidgetUpdatePayload } from '../widgets/updateHandlers'
